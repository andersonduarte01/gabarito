...
urlpatterns = [
    ...
    path('adicionar_sala/', views.UniAdicionarSala.as_view(), name='adicionar_sala'),
    path('editar_sala/<int:pk>/', views.UniEditarSala.as_view(), name='edit_sala'),
    path('<int:pk>/deletar/', views.UniDeletarSala.as_view(), name='deletar_sala'),
