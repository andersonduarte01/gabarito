...
urlpatterns = [
    ...
    path('registro/atividade/<int:pk>/', views.RegistroAdd.as_view(), name='registro_aluno'),
    ...
    path('<int:sala_id>/registros/atividades/', views.UniRegistroMesesSalas.as_view(), name='relatorio_meses'),
    path('<int:mes>/<int:pk>/mes/registros/atividades/', views.RegistroMesSala.as_view(), name='registro_mes'),
    path('registro/semanal', views.RegistroSemanal.as_view(), name='registro_semanal')
]
