...
urlpatterns = [
    ...
    path('<int:pk>/encerrar/',                                                       views.EncerrarView.as_view(),          name='encerrar'),
    ...
    path('<int:pk>/questao/<int:questao_pk>/opcao/<int:opcao_pk>/remover/',          views.RemoverOpcaoView.as_view(),     name='opcao_remover'),
